...
class BusinessSearch extends Business
{
    ...
    public function rules()
    {
        return [
            ...
            [['name', 'address', 'city', 'state', 'zip', 'phone', 'fax', 'url', 'president', 'about', 'url_fin_aid', 'url_admissions', 'url_apply', 'grad_rate', 'grad_rate_men', 'grad_rate_women', 'apply_fee', 'pct_adm_ttl', 'pct_adm_men', 'pct_adm_wmen', 'pct_fullfirst_any_finaid', 'avg_fullfirst_loan', 'pct_fullfirst_loan', 'avg_fullfirst_oloan', 'tuition_in', 'tuition_out', 'ft_grad_empl_grad', 'avg_start_sal', 'avg_ugrad_gpa', 'ft_grad_empl_3month'], 'safe'],
        ];
    }
