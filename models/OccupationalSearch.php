...
/**
 * OccupationalSearch represents the model behind the search form about `app\models\Occupational`.
 */
class OccupationalSearch extends Occupational
{
    /**
     * @inheritdoc
     */
