...
/**
 * PhysicalSearch represents the model behind the search form about `app\models\PhysicalTherapy`.
 */
class PhysicalSearch extends PhysicalTherapy
{
    /**
     * @inheritdoc
     */
