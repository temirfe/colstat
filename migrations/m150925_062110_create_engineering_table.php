...
class m150925_062110_create_engineering_table extends Migration
{
    public function up()
    {
        $this->createTable('engineering', [
            'id' => $this->primaryKey(),
        ...
        $this->createIndex('idx_engineering_name', 'engineering', 'name');
        $this->createIndex('idx_engineering_state', 'engineering', 'state');
    }

    public function down()
    {
        $this->dropTable('engineering');
    }
